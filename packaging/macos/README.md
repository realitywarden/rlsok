...
Check 1.5.10** in Applications. Its native local console shows package identity,
...
```sh
"/Applications/RLSOK Local Check 1.5.10.app/Contents/Resources/local-check/bin/rlsok" profile help
"/Applications/RLSOK Local Check 1.5.10.app/Contents/Resources/local-check/bin/rlsok" profile compose-templates --input base.template.json --input controller.template.json --output composed.template.json
```
...
Quit the app and move **RLSOK Local Check 1.5.10** from Applications to Trash.
