...
Check 1.5.3** in Applications and choose **Run example**. It saves two reports
...
```sh
"/Applications/RLSOK Local Check 1.5.3.app/Contents/Resources/local-check/bin/rlsok" profile help
```
...
Quit the app and move **RLSOK Local Check 1.5.3** from Applications to Trash.
