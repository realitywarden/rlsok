...
[![Local Check 1.5.6](https://img.shields.io/badge/Local_Check-1.5.6-blue)](https://github.com/realitywarden/rlsok/releases/tag/v1.5.6)
...
| --- | --- | --- |
| Windows 10/11, 64-bit | Local Check 1.5.6 ZIP with Node included | Extract the whole ZIP and open `START-HERE.html`. No ROS or database installation is needed for the file checks. |
| Mac with Apple silicon or Intel | Local Check 1.5.6 native app and installer for your processor | Install the matching package, open the app, and run the included example in the local console. The packages are unsigned and not Apple-notarized; read the first-open instructions. |
| Ubuntu 22.04 or 24.04, Intel/AMD 64-bit | Local Check 1.5.6 with its runtime included | Follow [the local first-run guide](docs/local-check-start.md). No robot, ROS installation or account is needed for the included example. |
...
[Local Check 1.5.6 package](https://github.com/realitywarden/rlsok/releases/tag/v1.5.6)
...
The [bounded-operation saved review](docs/bounded-operation-saved-review.md)
checks a declared task, permitted controller-local adjustments, terminating
conditions and optional temporal-perception reference inputs. It compares
selected files only; local control owns live classification and response, and
independent safety remains separate.
