...
Evaluation version: **v1.5.0-shadow.11**. Start with one command boundary in an isolated simulation. This guide covers the supplied local evaluator; Cloud-managed production authorization is a separate product path.
