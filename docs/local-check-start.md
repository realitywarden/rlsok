...
RLSOK Local Check **1.5.1** compares robot settings with a copy you reviewed.
...
curl -fLO https://github.com/realitywarden/rlsok/releases/download/v1.5.1/rlsok-local-check-1.5.1-linux-x64.tar.gz &&
curl -fLO https://github.com/realitywarden/rlsok/releases/download/v1.5.1/rlsok-local-check-1.5.1-linux-x64.tar.gz.sha256 &&
sha256sum -c rlsok-local-check-1.5.1-linux-x64.tar.gz.sha256 &&
tar -xzf rlsok-local-check-1.5.1-linux-x64.tar.gz &&
./rlsok-local-check-1.5.1/bin/rlsok profile demo --output first-result
```
...
`.sha256` file in [this release](https://github.com/realitywarden/rlsok/releases/tag/v1.5.1).
...
See [release notes and verification scope](releases/v1.5.1.md).
