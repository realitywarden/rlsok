...
Evaluation release: **v1.5.0-shadow.11**. Target: Ubuntu 22.04 x86_64 with
...
[evaluation release](https://github.com/realitywarden/rlsok/releases/tag/v1.5.0-shadow.11)
...
BASE=https://github.com/realitywarden/rlsok/releases/download/v1.5.0-shadow.11
curl -fLO "$BASE/install-shadow.sh"
curl -fLO "$BASE/install-shadow.sh.sha256"
sha256sum -c install-shadow.sh.sha256
sh install-shadow.sh "$HOME/rlsok-shadow-1.5.0-shadow.11"
EVAL="$HOME/rlsok-shadow-1.5.0-shadow.11"
...
licenses, the npm package and `rlsok-source-1.5.0-shadow.11.tar.gz`.
...
[the integration guide](https://github.com/realitywarden/rlsok/blob/v1.5.0-shadow.11/docs/fanuc-humble-integration.md).
