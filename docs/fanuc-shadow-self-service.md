...
Local Check release: **v1.5.4**. Target: Ubuntu 22.04 x86_64 with
...
[evaluation release](https://github.com/realitywarden/rlsok/releases/tag/v1.5.4)
...
BASE=https://github.com/realitywarden/rlsok/releases/download/v1.5.4
curl -fLO "$BASE/install-shadow.sh"
curl -fLO "$BASE/install-shadow.sh.sha256"
sha256sum -c install-shadow.sh.sha256
sh install-shadow.sh "$HOME/rlsok-shadow-1.5.4"
EVAL="$HOME/rlsok-shadow-1.5.4"
...
licenses, the npm package and `rlsok-source-1.5.4.tar.gz`.
...
[explicit absolute-WPR adapter](absolute-wpr-review.md) added in 1.5.2.
...
[the integration guide](https://github.com/realitywarden/rlsok/blob/v1.5.4/docs/fanuc-humble-integration.md).
