...
const help = `Composable ROS 2 Shadow profiles (local evaluation, zero dispatch)
  ...
  rlsok profile prepare-saved-setup --recipe <piper|metal|aditya-so101|beast|cartesian|kuka-sunrise|armpilot-remote|armpilot-3d> --source <checkout> --input <selected-files.json> --output <new-directory>
