...
const token=${safeToken};let catalog=null,catalogOrigin='none',fragments=[],workspace=null,formControls=null,projectFiles=[],inspections=[],folderCandidates=[],folderCatalogFiles=[],folderTemplateFiles=[];
...
}catch(error){folderCandidates=[];folderCatalogFiles=[];folderTemplateFiles=[];$('folderChoices').replaceChildren();$('folderSavedChoices').replaceChildren();$('inspectFolder').hidden=true;show('folderStatus',error.message||String(error),'bad')}};
