...
<div class="two"><label class="field">Data file<input id="localDataFile" type="file" accept=".json,.yaml,.yml"></label><label class="field">Parser<select id="localDataParser"><option value="json-records/v1">JSON records</option><option value="yaml-records/v1">YAML records</option></select></label></div>
...
let localDataInspection=null,localDataRules=[],localDataFragments=[];
